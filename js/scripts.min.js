...
$(function() {
  ...
  $(".ajax-form").submit(function(event) {
    ...
    if ((form.find('[name="tel"]').val() == "") && (form.find('[name="email"]').val() == "")) {
    	form.find('[name="tel"]').focus();
    	form.find('.popup_note').remove();
    	form.find('.popup__form').append('<p class="popup_note mt-1" style="position: absolute; color: red; font-size: 14px">Укажите Ваш телефон или e-mail</p>');
    	return false;
    }else{
    	form.find('.popup_note').remove();
